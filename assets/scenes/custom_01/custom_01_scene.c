...
*/
SceneCmd custom_01_scene_header00[] = {
    SCENE_CMD_COL_HEADER(&custom_01_scene_collisionHeader),
    SCENE_CMD_ROOM_LIST(1, custom_01_scene_roomList),
    ...
    SCENE_CMD_ENV_LIGHT_SETTINGS(4, custom_01_scene_header00_lightSettings),
    SCENE_CMD_SPAWN_LIST(custom_01_scene_header00_entranceList),
    SCENE_CMD_PLAYER_ENTRY_LIST(1, custom_01_scene_header00_playerEntryList),
#if ENABLE_ANIMATED_MATERIALS
    SCENE_CMD_ANIMATED_MATERIAL_LIST(custom_01_scene_header00_AnimMat, MATERIAL_CAM_PARAMS(ANIM_MAT_CAMERA_TYPE_NONE, false)),
#endif
    SCENE_CMD_END(),
};

RomFile custom_01_scene_roomList[] = {
    { (uintptr_t)_custom_01_room_0SegmentRomStart, (uintptr_t)_custom_01_room_0SegmentRomEnd },
};

ActorEntry custom_01_scene_header00_playerEntryList[] = {
    // Link / Spawn point
    {
...
Spawn custom_01_scene_header00_entranceList[] = {
    // { Spawn Actor List Index, Room Index }
    { 0, 0 },
};

EnvLightSettings custom_01_scene_header00_lightSettings[4] = {
...
#if ENABLE_ANIMATED_MATERIALS
AnimatedMaterial custom_01_scene_header00_AnimMat[] = {
    { 0, 6, NULL, NULL },
};
#endif
